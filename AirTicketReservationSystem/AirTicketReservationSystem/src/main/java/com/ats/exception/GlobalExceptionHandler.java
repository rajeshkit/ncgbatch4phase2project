...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<MyErrorDetails> handleMethodArgExceptionHandler(MethodArgumentNotValidException m){
        MyErrorDetails details = new MyErrorDetails();
        details.setTime(LocalDateTime.now());
...
//    Handling the flightException here
    @ExceptionHandler(FlightException.class)
    public ResponseEntity<MyErrorDetails> flightExceptionHandler(FlightException flightEx, WebRequest webReq){
        MyErrorDetails error = new MyErrorDetails(LocalDateTime.now(),flightEx.getMessage(),webReq.getDescription(false));
    ...
    @ExceptionHandler
    public ResponseEntity<MyErrorDetails> bookingExceptionHandler(ReservationException ex, WebRequest w){
        MyErrorDetails details = new MyErrorDetails();
