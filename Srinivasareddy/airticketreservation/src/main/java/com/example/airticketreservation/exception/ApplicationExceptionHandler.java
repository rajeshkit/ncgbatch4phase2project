...
public class ApplicationExceptionHandler {
    ...
    public ResponseEntity<ApiError> handlerCustomerIdNotFoundException(Exception ex){
    ...
    public ResponseEntity<ApiError> handlerFlightIdNotFoundException(Exception ex){
        ApiError api = new ApiError(new Date(),ex.getMessage(), "Check your flight id!! Enter valid flight Id");
        return new ResponseEntity<>(api, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(FlightNotFoundException.class)
    public ResponseEntity<ApiError> handlerFlightNotFoundException(Exception ex){
