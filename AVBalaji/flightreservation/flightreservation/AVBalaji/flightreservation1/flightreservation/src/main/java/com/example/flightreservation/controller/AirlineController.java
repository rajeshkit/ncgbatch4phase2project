...
public class AirlineController {
    ...
    public AirlineController(IAirlineService airlineService){
        ...
        public ResponseEntity<String> registerAirline(@RequestBody AirlineRequest airlineDTO)
        {
        ...
        @PutMapping("/update")
        public ResponseEntity<String> updateAirline(@RequestParam("id") int id , @RequestBody AirlineRequest airlineDTO)
        {
